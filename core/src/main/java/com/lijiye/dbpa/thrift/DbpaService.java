...
public class DbpaService {

  public interface Iface {

    public short add(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void add(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public short add(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails) throws org.apache.thrift.TException
    {
      send_add(matchDdetails);
      return recv_add();
    }

    public void send_add(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails) throws org.apache.thrift.TException
    {
      add_args args = new add_args();
      args.setMatchDdetails(matchDdetails);
      sendBase("add", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void add(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      add_call method_call = new add_call(matchDdetails, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class add_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails;
      public add_call(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.matchDdetails = matchDdetails;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class add<I extends Iface> extends org.apache.thrift.ProcessFunction<I, add_args> {
      ...
      public add_result getResult(I iface, add_args args) throws org.apache.thrift.TException {
        add_result result = new add_result();
        result.success = iface.add(args.matchDdetails);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class add<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, add_args, Short> {
      public add() {
        super("add");
      }
      ...
      public void start(I iface, add_args args, org.apache.thrift.async.AsyncMethodCallback<Short> resultHandler) throws TException {
        iface.add(args.matchDdetails,resultHandler);
      }
    }
  ...
  public static class add_args implements org.apache.thrift.TBase<add_args, add_args._Fields>, java.io.Serializable, Cloneable, Comparable<add_args>   {
    ...
    private static final org.apache.thrift.protocol.TField MATCH_DDETAILS_FIELD_DESC = new org.apache.thrift.protocol.TField("matchDdetails", org.apache.thrift.protocol.TType.LIST, (short)1);
    ...
    public List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      MATCH_DDETAILS((short)1, "matchDdetails");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // MATCH_DDETAILS
            return MATCH_DDETAILS;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.MATCH_DDETAILS, new org.apache.thrift.meta_data.FieldMetaData("matchDdetails", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.lijiye.dbpa.thrift.MatchDetail.class))));
    ...
    public add_args(
      List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails)
    {
      this();
      this.matchDdetails = matchDdetails;
    }
    ...
    public add_args(add_args other) {
      if (other.isSetMatchDdetails()) {
        List<com.lijiye.dbpa.thrift.MatchDetail> __this__matchDdetails = new ArrayList<com.lijiye.dbpa.thrift.MatchDetail>(other.matchDdetails.size());
        for (com.lijiye.dbpa.thrift.MatchDetail other_element : other.matchDdetails) {
          __this__matchDdetails.add(new com.lijiye.dbpa.thrift.MatchDetail(other_element));
        }
        this.matchDdetails = __this__matchDdetails;
      }
    }
    ...
    @Override
    public void clear() {
      this.matchDdetails = null;
    }

    public int getMatchDdetailsSize() {
      return (this.matchDdetails == null) ? 0 : this.matchDdetails.size();
    }

    public java.util.Iterator<com.lijiye.dbpa.thrift.MatchDetail> getMatchDdetailsIterator() {
      return (this.matchDdetails == null) ? null : this.matchDdetails.iterator();
    }

    public void addToMatchDdetails(com.lijiye.dbpa.thrift.MatchDetail elem) {
      if (this.matchDdetails == null) {
        this.matchDdetails = new ArrayList<com.lijiye.dbpa.thrift.MatchDetail>();
      }
      this.matchDdetails.add(elem);
    }

    public List<com.lijiye.dbpa.thrift.MatchDetail> getMatchDdetails() {
      return this.matchDdetails;
    }

    public add_args setMatchDdetails(List<com.lijiye.dbpa.thrift.MatchDetail> matchDdetails) {
      this.matchDdetails = matchDdetails;
      return this;
    }

    public void unsetMatchDdetails() {
      this.matchDdetails = null;
    }

    /** Returns true if field matchDdetails is set (has been assigned a value) and false otherwise */
    public boolean isSetMatchDdetails() {
      return this.matchDdetails != null;
    }

    public void setMatchDdetailsIsSet(boolean value) {
      if (!value) {
        this.matchDdetails = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case MATCH_DDETAILS:
        if (value == null) {
          ...
          setMatchDdetails((List<com.lijiye.dbpa.thrift.MatchDetail>)value);
        }
        break;
    ...
    public boolean equals(add_args that) {
      ...
      boolean this_present_matchDdetails = true && this.isSetMatchDdetails();
      boolean that_present_matchDdetails = true && that.isSetMatchDdetails();
      if (this_present_matchDdetails || that_present_matchDdetails) {
        if (!(this_present_matchDdetails && that_present_matchDdetails))
          return false;
        if (!this.matchDdetails.equals(that.matchDdetails))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_matchDdetails = true && (isSetMatchDdetails());
      list.add(present_matchDdetails);
      if (present_matchDdetails)
        list.add(matchDdetails);
    ...
    public int compareTo(add_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetMatchDdetails()).compareTo(other.isSetMatchDdetails());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetMatchDdetails()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.matchDdetails, other.matchDdetails);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("matchDdetails:");
      if (this.matchDdetails == null) {
        sb.append("null");
      } else {
        sb.append(this.matchDdetails);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class add_argsStandardScheme extends StandardScheme<add_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.matchDdetails = new ArrayList<com.lijiye.dbpa.thrift.MatchDetail>(_list16.size);
                  com.lijiye.dbpa.thrift.MatchDetail _elem17;
                  for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                  {
                    _elem17 = new com.lijiye.dbpa.thrift.MatchDetail();
                    _elem17.read(iprot);
                    struct.matchDdetails.add(_elem17);
                  }
                  iprot.readListEnd();
                }
                struct.setMatchDdetailsIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, add_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.matchDdetails != null) {
          oprot.writeFieldBegin(MATCH_DDETAILS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.matchDdetails.size()));
            for (com.lijiye.dbpa.thrift.MatchDetail _iter19 : struct.matchDdetails)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class add_argsTupleScheme extends TupleScheme<add_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, add_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetMatchDdetails()) {
          optionals.set(0);
        }
        oprot.writeBitSet(optionals, 1);
        if (struct.isSetMatchDdetails()) {
          {
            oprot.writeI32(struct.matchDdetails.size());
            for (com.lijiye.dbpa.thrift.MatchDetail _iter20 : struct.matchDdetails)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.matchDdetails = new ArrayList<com.lijiye.dbpa.thrift.MatchDetail>(_list21.size);
            com.lijiye.dbpa.thrift.MatchDetail _elem22;
            for (int _i23 = 0; _i23 < _list21.size; ++_i23)
            {
              _elem22 = new MatchDetail();
              _elem22.read(iprot);
              struct.matchDdetails.add(_elem22);
            }
          }
          struct.setMatchDdetailsIsSet(true);
        }
